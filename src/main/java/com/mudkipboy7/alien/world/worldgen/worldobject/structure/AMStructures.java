...
public class AMStructures {
	...
	public static void bootstrap(BootstapContext<Structure> context) {
		...
		//context.register(JOVIAN_PLANET_ARENA, new JovianArena(structure(structures.getOrThrow(BiomeTags.HAS_MINESHAFT), GenerationStep.Decoration.UNDERGROUND_STRUCTURES, TerrainAdjustment.NONE), MineshaftStructure.Type.NORMAL));
	}
