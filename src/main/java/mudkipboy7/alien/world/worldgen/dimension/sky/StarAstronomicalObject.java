...
public class StarAstronomicalObject extends AstronomicalObject {
	private long seed = 10842L;
	private int count = 1500;

	public StarAstronomicalObject(AlienDimSky sky, float minBrightness, long seed, int count) {
		super(sky, minBrightness, 1.0F, AlienDimSky.SUN_TEXTURE);
		this.seed = 94373L;
	}

	@Override
	public float getBrightness(float eclipsyness, float sunLocation) {
