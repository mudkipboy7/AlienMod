...
public class AMBlockEntities {
	...
	// Hazard Remover
	public static final RegistryObject<BlockEntityType<HazardRemoverBlockEntity>> HAZARD_REMOVER = BLOCK_ENTITY_TYPES
			.register("air_purifier", () -> BlockEntityType.Builder
					.of(HazardRemoverBlockEntity::new, AMBlocks.AIR_PURIFIER.get()).build(null));
