...
import mudkipboy7.alien.world.item.functional.AmmoniaLiquidBucketItem;
import mudkipboy7.alien.world.item.functional.BatteryItem;
import mudkipboy7.alien.world.item.functional.tool.AMTeirs;
import mudkipboy7.alien.world.item.functional.tool.AlienAxeItem;
import mudkipboy7.alien.world.item.functional.tool.AlienHoeItem;
import mudkipboy7.alien.world.item.functional.tool.AlienPickaxeItem;
import mudkipboy7.alien.world.item.functional.tool.AlienShovelItem;
import mudkipboy7.alien.world.item.functional.tool.AlienSwordItem;
import mudkipboy7.alien.world.item.functional.wearable.AMArmorMaterials;
import mudkipboy7.alien.world.item.functional.wearable.SurvivalArmorItem;
import mudkipboy7.alien.world.item.functional.wearable.SurvivalGearItem;
import mudkipboy7.alien.world.item.misc.BlockEntityItem;
import mudkipboy7.alien.world.item.misc.TestItem;
...
public class AMItems {
	...
	public static final RegistryObject<AmmoniaLiquidBucketItem> AMMONIA_LIQUID_BUCKET = ITEMS.register(
			"ammonia_liquid_bucket",
			() -> new AmmoniaLiquidBucketItem(AMFluids.AMMONIA_LIQUID_SOURCE, new Item.Properties().stacksTo(1)));
