package mudkipboy7.alien.client;
...
import mudkipboy7.alien.client.gui.screen.CoalGeneratorScreen;
import mudkipboy7.alien.client.gui.screen.EnergyStorageScreen;
import mudkipboy7.alien.client.gui.screen.HazardRemovalScreen;
import mudkipboy7.alien.client.render.dim.AlienDimSkyRenderer;
import mudkipboy7.alien.client.render.dim.AlienDimSpecialEffects;
...
public class AMClientEvents {
	...
	public static class ModBus {
		...
		public static void onClientSetup(FMLClientSetupEvent event) {
			ItemBlockRenderTypes.setRenderLayer(AMFluids.AMMONIA_LIQUID_SOURCE.get(), RenderType.translucent());
